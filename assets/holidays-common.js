...
(function () {
    ...
    .goods-list.sale .list-wrap .card .submit-btn a, .goods-list .list-wrap .season-sale-card .btn-wrap .main-btn');
    ...
    window.addEventListener('scroll', (e) => {
        ...
        if (document.querySelector('.sale-logo')) {
            if (document.querySelector('.lumen-page .goods-list')) {
                if (document.querySelector('.lumen-page .goods-list').offsetTop - 50 > last_known_scroll_position) {
                    document.querySelector('.sale-logo').classList.add('show');
                } else {
                    document.querySelector('.sale-logo').classList.remove('show');
                }
            }
            if (document.querySelector('.about-content .goods-list')) {
                if (document.querySelector('.about-content .goods-list').offsetTop > last_known_scroll_position) {
                    document.querySelector('.sale-logo').classList.add('show');
                } else {
                    document.querySelector('.sale-logo').classList.remove('show');
                }
        ...
        if (document.querySelector('.fixed-sale-line .season-sale')) {
              if (document.querySelector('.lumen-page .goods-list')) {
                  if (document.querySelector('.lumen-page .goods-list').offsetTop - 50 < last_known_scroll_position) {
                      document.querySelector('.fixed-sale-line .season-sale').classList.add('hide');
                  } else {
                      document.querySelector('.fixed-sale-line .season-sale').classList.remove('hide');
                  }
              }
              if (document.querySelector('.about-content .goods-list')) {
                  if (document.querySelector('.about-content .goods-list').offsetTop + 50 < last_known_scroll_position) {
                      document.querySelector('.fixed-sale-line .season-sale').classList.add('hide');
                  } else {
                      document.querySelector('.fixed-sale-line .season-sale').classList.remove('hide');
                  }
    ...
    if (document.querySelector('.sale-logo')) {
        document.querySelector('.sale-logo a').addEventListener('click', (e) => {
            e.preventDefault();
            if (document.querySelector('.goods-list')) {
                document.querySelector('.goods-list').scrollIntoView({
                    behavior: 'smooth',
